...
```
  ...
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
  | :8199      | POST     | /user/check-passport   | election/internal/controller.(*cUser).CheckPassport                          | service.(*sMiddleware).Ctx     |
  |            |          |                        | service.(*sMiddleware).CORS                                                  |
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
  | :8199      | POST     | /user/is-signed-in     | election/internal/controller.(*cUser).IsSignedIn                             | service.(*sMiddleware).Ctx     |
  |            |          |                        | service.(*sMiddleware).CORS                                                  |
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
  | :8199      | GET      | /user/profile          | election/internal/controller.(*cUser).Profile                                | service.(*sMiddleware).Ctx     |
  |            |          |                        | service.(*sMiddleware).CORS                                                  |
  |            |          |                        | service.(*sMiddleware).Auth                                                  |
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
  | :8199      | POST     | /user/sign-in          | election/internal/controller.(*cUser).SignIn                                 | service.(*sMiddleware).Ctx     |
  |            |          |                        | service.(*sMiddleware).CORS                                                  |
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
  | :8199      | POST     | /user/sign-out         | election/internal/controller.(*cUser).SignOut                                | service.(*sMiddleware).Ctx     |
  |            |          |                        | service.(*sMiddleware).CORS                                                  |
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
  | :8199      | POST     | /user/sign-up          | election/internal/controller.(*cUser).SignUp                                 | service.(*sMiddleware).Ctx     |
  |            |          |                        | service.(*sMiddleware).CORS                                                  |
  | ---------- | -------- | ---------------------- | ---------------------------------------------------------------------------- | ------------------------------ |
```
